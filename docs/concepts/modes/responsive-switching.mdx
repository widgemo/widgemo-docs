...
Each showcase below renders the same data in the mode active at that breakpoint. Resize your browser to see the actual switching behavior in a single config.
