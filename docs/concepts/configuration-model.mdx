...
2. **`zones`** — compose the Widgemo surface into named structural regions: `header` chrome, `content` data area, `footer` chrome
...
1. **`zones`** — how many regions does the Widgemo have? What titles and actions do they carry?
