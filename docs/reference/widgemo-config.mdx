...
For the full `ZoneConfig` shape, all `ZoneLayout` position options (with live showcases for every variant), icon, collapse, and `themeOverrides`, see [Zone Config](/core/reference/zone-config).
