...
| Export | Kind | Purpose |
|---|---|---|
| `widgemoColors` | Namespace object | Color manipulation and palette helpers |
| `parseTemporalValue` | Function | Parse raw temporal values into `Date` |
| `parseDurationValue` | Function | Normalize raw durations into milliseconds |
| `isTemporalParseMode` | Function | Validate `TemporalParseMode` strings |
| `generateId` | Function | Create stable-ish generated ids |
| `isValidEmail` | Function | Validate email syntax |
...
|---|---|---|
| `parseTemporalValue` | `(value, parseMode) => Date \| null` | Parsed `Date` or `null` |
| `parseDurationValue` | `(value, unit) => number` | Milliseconds |
| `isTemporalParseMode` | `(value) => boolean` | Type-guard result |
...
|---|---|---|
| `generateId` | `() => string` | Generate a stable-ish identifier string |
| `isValidEmail` | `(value) => boolean` | Validate email syntax |
