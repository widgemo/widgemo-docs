...
Every grid setting is represented by at least one live example on the [Grid Mode](/core/concepts/modes/grid) guide page:
...
- [Grid Mode](/core/concepts/modes/grid) — examples and showcases
