...
Every table setting is represented by at least one interactive example on the [Table Mode](/core/concepts/modes/table) guide page:
...
- [Table Mode](/core/concepts/modes/table) — examples, configuration references, and grouping UI controls
