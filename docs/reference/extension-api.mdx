...
Widgemo exposes two complementary extension surfaces: registry-based lifecycle hooks (this page) and config-based interaction handling via [gestures](/core/reference/widgemo-config#gestures-and-interaction-handling) and [interactions.onEvent](/core/reference/widgemo-config#interactionsonevent).
