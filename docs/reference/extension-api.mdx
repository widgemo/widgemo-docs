...
Widgemo exposes two complementary extension surfaces: registry-based lifecycle hooks (this page) and config-based interaction handling via [gestures](/core/reference/content-config#gestures) and [interactions.onEvent](/core/reference/widgemo-config#interactionsonevent).
