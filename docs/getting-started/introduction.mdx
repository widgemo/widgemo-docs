...
2. [Quick Start](/core/getting-started/quick-start) — first widget in under five minutes.
3. [First Widget Walkthrough](/core/getting-started/first-widget-walkthrough) — step-by-step path to a production-safe baseline.
