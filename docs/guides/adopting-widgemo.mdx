...
**Reference:** [Content Config: Actions and Interactions](/core/reference/content-config#actions-and-interactions) · [Content Config: Gestures](/core/reference/content-config#gestures)
