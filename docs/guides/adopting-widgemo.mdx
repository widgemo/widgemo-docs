...
**Reference:** [Content Config: Actions and Interactions](/core/reference/content-config#actions) · [Content Config: Gestures](/core/reference/content-config#gestures)
